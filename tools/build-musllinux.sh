...
function check_wheel() {
  ...
  for FILE in *.whl; do
    ...
    auditwheel -v repair --plat "musllinux_1_2_$PLATFORM" "$FILE" -w .
    #auditwheel -v repair --plat musllinux_1_2_x86_64 "$FILE" -w .
    #auditwheel -v repair --plat musllinux_1_2_aarch64 "$FILE" -w .
  done
  popd
